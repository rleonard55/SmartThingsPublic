...
*    https://github.com/adamoutler/SmartThingsPublic/blob/master/devicetypes/adamoutler/lightify-dimming-switch-zigbee.src/lightify-dimming-switch-zigbee.groovy
*/
...
*/
 tiles(scale: 2) {
  standardTile("button", "device.state", width: 6, height: 4,canChangeIcon: true,) {
